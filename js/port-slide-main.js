...
;(function(window) {
	...
	CircleSlideshow.prototype._init = function() {
		...
		this.navLeftCtrl.innerHTML = '<svg width="80px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#3e8d79" stroke-width="10"  points="69.821,3.795 92.232,26.205 0,26.205"/></svg>';
		...
		this.navRightCtrl.innerHTML = '<svg width="80px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#3e8d79" stroke-width="10" points="30.179,26.205 7.768,3.795 100,3.795"/></svg>';
	...
	CircleSlideshow.prototype._openContent = function(item) {
		...
		var self = this,
			...
			largeImgEl1 = contentEl.querySelector('.slide__img--large1'),
			largeImgEl2 = contentEl.querySelector('.slide__img--large2'),
			largeImgEl3 = contentEl.querySelector('.slide__img--large3'),
			largeImgEl4 = contentEl.querySelector('.slide__img--large4'),
			largeImgEl5 = contentEl.querySelector('.slide__img--large5'),
			largeImgEl6 = contentEl.querySelector('.slide__img--large6'),
			largeImgEl7 = contentEl.querySelector('.slide__img--large7'),
			largeImgEl8 = contentEl.querySelector('.slide__img--large8'),
			largeImgEl9 = contentEl.querySelector('.slide__img--large9'),
			largeImgEl10 = contentEl.querySelector('.slide__img--large10'),
			largeImgEl11 = contentEl.querySelector('.slide__img--large11'),
			largeImgEl12 = contentEl.querySelector('.slide__img--large12'),
			
			titleEl1 = contentEl.querySelector('.slide__title--main1'),
			titleEl2 = contentEl.querySelector('.slide__title--main2'),
			titleEl3 = contentEl.querySelector('.slide__title--main3'),
			titleEl4 = contentEl.querySelector('.slide__title--main4'),
			titleEl5 = contentEl.querySelector('.slide__title--main5'),
			titleEl6 = contentEl.querySelector('.slide__title--main6'),
			titleEl7 = contentEl.querySelector('.slide__title--main7'),
			titleEl8 = contentEl.querySelector('.slide__title--main8'),
			titleEl9 = contentEl.querySelector('.slide__title--main9'),
			titleEl10 = contentEl.querySelector('.slide__title--main10'),
			titleEl11 = contentEl.querySelector('.slide__title--main11'),
			titleEl12 = contentEl.querySelector('.slide__title--main12'),
		...
		// - image (large image)
		dynamics.css(largeImgEl1, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl2, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl3, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl4, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl5, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl6, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl7, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl8, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl9, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl10, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl11, {translateY : 1000, opacity: 0});
		dynamics.css(largeImgEl12, {translateY : 1000, opacity: 0});
		
		// - title
		dynamics.css(titleEl1, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl2, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl3, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl4, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl5, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl6, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl7, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl8, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl9, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl10, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl11, {translateY : 1000, opacity: 0});
		dynamics.css(titleEl12, {translateY : 1000, opacity: 0});
		...
		dynamics.animate(expanderEl, 
			...
			{
				type: dynamics.bezier, points: [{"x":0,"y":0,"cp":[{"x":0.5,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.5,"y":1}]}], duration: 700
			}
		);
		...
		dynamics.animate(smallImgEl, 
			...
			{
				type: dynamics.bezier, points: [{"x":0,"y":0,"cp":[{"x":0.2,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.3,"y":1}]}], duration: 300, delay: 10
			}
		);

		// animate the large image in
		dynamics.animate(largeImgEl1, 
			{
				translateY : 0, opacity : 1
			}, 
			{
				type: dynamics.bezier, points: [{"x":0,"y":0,"cp":[{"x":0.2,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.3,"y":1}]}], duration: 1000, delay: 10
			}
		);

		dynamics.animate(largeImgEl2, 
			{
				translateY : 0, opacity : 1
			}, 
			{
		...
		dynamics.animate(buyEl, 
			...
			{
				type: dynamics.bezier, points: [{"x":0,"y":0,"cp":[{"x":0.2,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.3,"y":1}]}], duration: 100, delay: 10,
				complete: function() {
	...
	CircleSlideshow.prototype._closeContent = function() {
		...
		dynamics.animate(smallImgEl, 
			...
			{
				type: dynamics.bezier, points: [{"x":0,"y":0,"cp":[{"x":0.2,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.3,"y":1}]}], duration: 700, delay: 10
			}
		);
		...
		dynamics.animate(expanderEl, 
			...
			{
				type: dynamics.bezier, points: [{"x":0,"y":0,"cp":[{"x":0.5,"y":1}]},{"x":1,"y":1,"cp":[{"x":0.5,"y":1}]}], duration: 100, delay: 10
			}
		);
	};
