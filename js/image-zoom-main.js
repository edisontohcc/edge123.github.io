...
;(function(window) {
	...
	function GridFx(el, options) {
		...
		this.items = [].slice.call(this.gridEl.querySelectorAll('.image-zoom-grid__item'));
		this.previewEl = nextSibling(this.gridEl);
		this.isExpanded = false;
		this.isAnimating = false;
		this.closeCtrl = this.previewEl.querySelector('button.image-zoom-action--close');
	...
	GridFx.prototype._init = function() {
		...
		imagesLoaded( this.gridEl, function() {
			...
			new Masonry(self.gridEl, {
				itemSelector: '.image-zoom-grid__item',
				isFitWidth : true
			});
